...
- 해싱 알고리즘으로 HS256을 대체로 많이 사용합니다. 
  HS256은 HMAC SHA256을 말하며, 지원하는 알고리즘을 [jwt.io Libraries](https://jwt.io/#libraries-io) 에서 확인할 수 있습니다. 



#### 알고리즘

앞으로의 테스트에 사용할 알고리즘은 HS256과 RS256입니다.
...
- [공개키 제공 방법의 예: Google Cloud 서비스 계정 키 생성](https://cloud.google.com/iam/docs/creating-managing-service-account-keys?hl=ko#creating_service_account_keys)
