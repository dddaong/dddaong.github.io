...
categories: F5 BIG-IP SNMP
---

F5 BIG-IP SNMP OID에 대한 내용을 정리한 포스트입니다.



## BIG-IP SNMP OID / Disk
...
| CPU Usage     | sysMultiHostCpuUser5s       | .1.3.6.1.4.1.3375.2.1.7.5.2.1.12 |
...
| **항목값**                                 | **설명**                                                     |
| ------------------------------------------ | ------------------------------------------------------------ |
| **Thoughput**                              | Management 인터페이스를 제외하고, <br />TMM, PVA 스위치보드를 비롯한 BIG-IP Device의 모든 인터페이스에서 수집한 Throughput 합산 값입니다.(Dashboard에서는 Management Interface Traffic까지 포함된다고 합니다.) <br /><br />In: Client-side in/out 트래픽 합계<br />Out: Server-side in/out 트래픽 합계<br />Service: Request(Client-side in + Server-side Out), Response(Service-side in + Client-side Out) 값 중 큰 값입니다. |
| **TMM Client-side Throughput****[Detail]** | Client-side의 TMM, PVA에 의해 처리된 합계 throughput입니다. <br /><br />Client in: 유입(Ingress) 트래픽 합계<br />Client out: 유출(Egress) 트래픽 합계 |
| **TMM Server-side Throughput****[Detail]** | Server-side의 TMM, PVA에 의해 처리된 합계 throughput입니다. <br /><br />Server in: 유입(Ingress) 트래픽 합계<br />Server out: 유출(Egress) 트래픽 합계 |
...
| **Statistic**        |             | **Object Name (OID)**                                        |                                                              |
| -------------------- | ----------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| **Throughput**       | Client In   | sysStatClientBytesIn.0<br/><br/>sysStatClientPktsIn.0<br/><br/>sysStatClientBytesIn5s.0<br/><br/>sysStatClientPktsIn5s.0 | .1.3.6.1.4.1.3375.2.1.1.2.1.3.0<br/><br/>.1.3.6.1.4.1.3375.2.1.1.2.1.2.0<br/><br/>.1.3.6.1.4.1.3375.2.1.1.2.1.60.0<br/><br/>.1.3.6.1.4.1.3375.2.1.1.2.1.59.0 |
|                      | Client Out  | sysStatClientBytesOut.0<br/><br/>sysStatClientPktsOut.0<br/><br/>sysStatClientBytesOut5s.0<br/><br/>sysStatClientPktsOut5s.0 | .1.3.6.1.4.1.3375.2.1.1.2.1.5.0<br/><br/>.1.3.6.1.4.1.3375.2.1.1.2.1.4.0<br/><br/>.1.3.6.1.4.1.3375.2.1.1.2.1.62.0<br/><br/>.1.3.6.1.4.1.3375.2.1.1.2.1.61.0 |
|                      | Server In   | sysStatServerBytesIn.0<br/><br/>sysStatServerPktsIn.0<br/><br/>sysStatServerBytesIn5s.0<br/><br/>sysStatServerPktsIn5s.0 | .1.3.6.1.4.1.3375.2.1.1.2.1.10.0<br/><br/>.1.3.6.1.4.1.3375.2.1.1.2.1.9.0<br/><br/>.1.3.6.1.4.1.3375.2.1.1.2.1.67.0<br/><br/>.1.3.6.1.4.1.3375.2.1.1.2.1.66.0 |
|                      | Server Out  | sysStatServerBytesOut.0<br/><br/>sysStatServerPktsOut.0<br/><br/>sysStatServerBytesOut5s.0<br/><br/>sysStatServerPktsOut5s.0 | .1.3.6.1.4.1.3375.2.1.1.2.1.12.0<br/><br/>.1.3.6.1.4.1.3375.2.1.1.2.1.11.0<br/><br/>.1.3.6.1.4.1.3375.2.1.1.2.1.69.0<br/><br/>.1.3.6.1.4.1.3375.2.1.1.2.1.68.0 |
| **Connection Count** | Client-side | sysStatClientMaxConns.0<br/><br/>sysStatClientTotConns.0<br/><br/>sysStatClientCurConns.0<br/><br/>sysStatClientMaxConns5s.0<br/><br/>sysStatClientTotConns5s.0<br/><br/>sysStatClientCurConns5s.0 | .1.3.6.1.4.1.3375.2.1.1.2.1.6.0<br/><br/>.1.3.6.1.4.1.3375.2.1.1.2.1.7.0<br/><br/>.1.3.6.1.4.1.3375.2.1.1.2.1.8.0<br/><br/>.1.3.6.1.4.1.3375.2.1.1.2.1.63.0<br/><br/>.1.3.6.1.4.1.3375.2.1.1.2.1.64.0<br/><br/>.1.3.6.1.4.1.3375.2.1.1.2.1.65.0 |
|                      | Server-side | sysStatServerMaxConns.0<br/><br/>sysStatServerTotConns.0<br/><br/>sysStatServerCurConns.0<br/><br/>sysStatServerMaxConns5s.0<br/><br/>sysStatServerTotConns5s.0<br/><br/>sysStatServerCurConns5s.0 | .1.3.6.1.4.1.3375.2.1.1.2.1.13.0<br/><br/>.1.3.6.1.4.1.3375.2.1.1.2.1.14.0<br/><br/>.1.3.6.1.4.1.3375.2.1.1.2.1.15.0<br/><br/>.1.3.6.1.4.1.3375.2.1.1.2.1.70.0<br/><br/>.1.3.6.1.4.1.3375.2.1.1.2.1.71.0<br/><br/>.1.3.6.1.4.1.3375.2.1.1.2.1.72.0 |
|                      |             | sysTcpStatAccepts.0<br/><br/>sysTcpStatConnects.0            | .1.3.6.1.4.1.3375.2.1.1.2.12.6.0<br/><br/>.1.3.6.1.4.1.3375.2.1.1.2.12.8.0 |
