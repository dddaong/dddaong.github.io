...
1. 먼저 Debian 리눅스 이미지를 Docker Hub에서 Pull 합니다.

   ```bash
   docker pull debian:buster-slim
   ```

2. hosts 파일에 dddaong.test의 IP를 작성해 주고, 
...
4. Pull 테스트를 위해 Docker Hub에서 가져온 Debian 리눅스 이미지를 삭제합니다.
...
5. dddaong.test:44443에서 debian 리눅스를 Pull 해봅니다.
